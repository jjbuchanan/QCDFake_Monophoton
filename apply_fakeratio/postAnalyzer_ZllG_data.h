...
public :
   ...
   TH1F *h_nVtx[30], *h_photon_Et_range[30], *h_photon_SCEta[30], *h_photon_SCPhi[30], *h_pfMET[30], *h_dPhi_phoMET[30], *h_nJet[30], *h_leadingJetPt[30], *h_leadingJetEta[30], *h_PTMET[30];
   TH1F *h_leadingLeptonPt[30], *h_leadingLeptonEta[30], *h_leadingLeptonPhi[30], *h_subleadingLeptonPt[30], *h_subleadingLeptonEta[30], *h_subleadingLeptonPhi[30], *h_dileptonPt[30], *h_dileptonM[30], *h_photonic_recoil[30], *h_dPhi_phoRecoil[30];
   TH1F *h_phoPT_over_dileptonPt[30], *h_phoPT_over_photonicRecoil[30], *h_photonicRecoil_over_dileptonPt[30];
   TH1F *h_dileptonPt_over_pfMET[30], *h_photonicRecoil_over_pfMET[30];
   TH1F *h_min_dphijetmet[30], *h_min_dphijetrecoil[30], *h_dPhi_leptons[30], *h_dPhi_phoRecoil_fullrange[30];
   TH1F *h_pfMETsumEt[30], *h_METoverSqrtSumEt_extended[30], *h_METoverSqrtSumEt[30];
   TH2F *h_phoIEtaIPhi[30];
   TH1F *h_phoRecoilMt[30];
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void fillHistos(int histoNumber, double event_weight,int index,std::vector<int> jets,int lepindex_leading,int lepindex_subleading,Double_t dilepton_mass,Double_t dilepton_pt,Double_t leptoMET,Double_t leptoMET_phi);
   ...
   virtual vector<int> electron_veto_looseID(int pho_index, int leading_mu_index, int subleading_mu_index, float elePtCut);
   virtual vector<int> electron_veto_tightID(int pho_index, float elePtCut);
   virtual vector<int> muon_veto_looseID(int pho_index, int leading_ele_index, int subleading_ele_index, float muPtCut);
   virtual vector<int> muon_veto_tightID(int pho_index, float muPtCut);
   double FakeRatePt(Float_t phoPt, int sysbin);
   virtual vector<int> JetVetoDecision(int pho_index, int leading_lep_index, int subleading_lep_index);
