...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual vector<int> getPhoCand_MIPTotEnergyUp(double pt, double eta, Short_t isobits);
   virtual vector<int> getPhoCand_MIPTotEnergyDown(double pt, double eta, Short_t isobits);
