                      ...
                      if(pfMET > 50)
                      {
                        ...
                        if(lepMET_MT < 160)
                        {
                          if(uncorrectedPhoEt/leptoMET < 1.4){
                            ...
                            fillHistos(6,event_weight_sidebandUp,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                            fillHistos(7,event_weight_sidebandDown,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                            fillHistos(8,event_weight_METUp,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                            fillHistos(9,event_weight_METDown,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                            fillHistos(10,event_weight_binningUp,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                            fillHistos(11,event_weight_binningDown,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                            fillHistos(12,event_weight_sieieLeft,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                            fillHistos(13,event_weight_sieieRight,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                            fillHistos(14,event_weight_templateUp,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                            fillHistos(15,event_weight_templateDown,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                            fillHistos(16,1.0,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
